public class App {
    public static void main(String[] args) throws Exception {
         ...
         */
        Wizard Magi = new Wizard("Magi");
        Warlock Ajeel = new Warlock("Ajeel");
        Ajeel.fireStorm(Magi);
        Ajeel.manaCost(Ajeel);
        Magi.displayDetails();
        Magi.heal(Magi);
        Magi.displayDetails();
        Magi.endlessVoid(Ajeel);
        Magi.manaCost1(Magi);
        Ajeel.displayDetails();
        Ajeel.lightningBlast(Magi);
        Ajeel.manaCost1(Ajeel);
        Magi.displayDetails();
        Magi.endlessVoid(Ajeel);
        Magi.increaseLvl(Magi, 10);
    }
}
